...
export default function FlowerRoom() {
    ...
    return (
        <div
            className="min-h-screen p-5 max-w-3xl mx-auto"
        ...
        >
                                ...
                                <div key={`seat-${player.seat}`}
                                    ...
                                    <div>
                                        ...
                                        {statusParts.length > 0 &&
                                            <div className="text-xs text-gray-500 mt-1">{statusParts.join(" · ")}</div>}
                                    </div>
            ...
            <div className="p-3 border rounded mb-4">
                ...
                {flowerSnapshot ? (
                    ...
                    <div className="text-sm text-red-600 mb-3">还没有收到 <b>flower:state</b>（请创建/加入房间后再试）
                    </div>
                )}
                ...
                {flowerPhase === "lobby" && (
                    <div className="flex flex-wrap gap-2 items-center">
                        ...
                        <button
                            className={`px-4 py-2 rounded ${isHost && roomCode
                                ? "bg-black text-white"
